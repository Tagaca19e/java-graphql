...
public class VoteRepository {
  ...
  public VoteRepository(MongoCollection<Document> votes) { this.votes = votes; }
  ...
  public Vote saveVote(Vote vote) {
    ...
    votes.insertOne(doc);
    return new Vote(doc.get("_id").toString(), vote.getCreatedAt(),
                    vote.getUserId(), vote.getLinkId());
  }

  // Converts MongoDB document to a Vote class.
